window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-08-17T04:55:18.9692798+00:00",
  "weekly": [
    {
      "owner": "cathrynlavery",
      "repo": "diagram-design",
      ...
      "insight": {
        ...
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：29 editorial diagram types for Claude Code. Self-contained HTML + SVG. No shadows, no Mermaid-slop.",
        "projectIntro": "该项目的 GitHub 简介是：29 editorial diagram types for Claude Code. Self-contained HTML + SVG. No shadows, no Mermaid-slop.",
        "featurePoints": [
          "核心线索：29 editorial diagram types for Claude Code. Self-contained HTML + SVG. No shadows, no Mermaid-slop."
        ],
        "scenarioPoints": [
    ...
    },
    {
      ...
      "insight": {
        ...
        "scenarioPoints": [
          ...
          "可按 README 示例落地：That quickstart path now defaults to trusted local loopback mode for the fastest first run. To start in authenticated/private mode instead, choose a bind preset explicitly:"
        ]
      }
    },
    {
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/57667706?s=40&v=4",
      ...
      "insight": {
        ...
        "scenarioPoints": [
          ...
          "适用线索：If you want to self-host ToolJet, kindly proceed to deployment documentation."
        ]
      }
    },
    {
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。",
          "适用线索：Choose the launcher path to run Claude Code, Codex CLI, or OpenClaw through"
        ]
      }
    }
  ],
