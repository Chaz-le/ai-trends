window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-09-23T04:36:56.2359037+00:00",
  "weekly": [
    {
      "owner": "cloudflare",
    ...
    },
    {
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合习惯命令行开发、希望用 AI 处理代码修改、调试和多步骤工程任务的开发者。",
          "适用线索：Using an agent sandbox that reaps background processes after each command?"
        ]
      }
    },
    {
