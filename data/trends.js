window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-08-20T01:46:23.6289940+00:00",
  "weekly": [
    {
      "owner": "cathrynlavery",
      "repo": "diagram-design",
    ...
    },
    {
      ...
      "insight": {
        ...
        "projectIntro": "该项目的 GitHub 简介是：14MB foundation model for tiny devices; phones, wearables, smart home, and robots.",
        "featurePoints": [
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/23090290?s=40&v=4",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/6412775?s=40&v=4",
      ...
      "insight": {
        "source": "readme",
        "readmeTitle": "Why Macro",
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：Macro is a unified workspace for teams: email, chat, docs, tasks, agents, calls, and CRM — @-linked together with shared AI memory.",
        "projectIntro": "该项目的 GitHub 简介是：Macro is a unified workspace for teams: email, chat, docs, tasks, agents, calls, and CRM — @-linked together with shared AI memory.",
        "featurePoints": [
          "核心线索：Macro is a unified workspace for teams: email, chat, docs, tasks, agents, calls, and CRM — @-linked together with shared AI memory."
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。"
        ]
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/63157773?s=40&v=4",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/64250138?s=40&v=4",
      ...
      "insight": {
        "source": "readme",
        "readmeTitle": "Upgrade to the latest version",
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：LLM inference server with continuous batching & SSD caching for Apple Silicon — managed from the macOS menu bar",
        "projectIntro": "该项目的 GitHub 简介是：LLM inference server with continuous batching & SSD caching for Apple Silicon — managed from the macOS menu bar",
        "featurePoints": [
          "核心线索：LLM inference server with continuous batching & SSD caching for Apple Silicon — managed from the macOS menu bar"
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。",
          "适用线索：To connect OpenClaw, OpenCode, Codex, Hermes Agent, or Copilot, see Integrations."
        ]
      }
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/1593821?s=40&v=4",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/20358651?s=40&v=4",
      ...
      "insight": {
        ...
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：🧱 easy fast local-first microVM runtime and library",
        "projectIntro": "该项目的 GitHub 简介是：🧱 easy fast local-first microVM runtime and library",
        "featurePoints": [
          "核心线索：🧱 easy fast local-first microVM runtime and library"
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。"
        ]
  ...
  "monthly": [
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/514052?s=40&v=4",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/11430621?s=40&v=4",
      ...
      "insight": {
        ...
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：The open-source alternative to Claude Cowork (powered by opencode)",
        "projectIntro": "该项目的 GitHub 简介是：The open-source alternative to Claude Cowork (powered by opencode)",
        "featurePoints": [
          "核心线索：The open-source alternative to Claude Cowork (powered by opencode)"
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。"
        ]
