window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-09-19T08:46:21.8296058+00:00",
  "weekly": [
    {
      "owner": "alibaba",
    ...
    },
    {
      ...
      "insight": {
        "source": "readme",
        "readmeTitle": "💡 WeKnora — Turn Documents into Living Knowledge with RAG, Agents and Auto-Wiki",
        "category": "rag-search",
        "zhTitle": "RAG / 语义检索工具",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/45416?s=40&v=4",
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合习惯命令行开发、希望用 AI 处理代码修改、调试和多步骤工程任务的开发者。",
          "适用线索：brainstorming - Activates before writing code. Refines rough ideas through questions, explores alternatives, presents design in sections for validation. Saves design document."
        ]
      }
    },
    {
    ...
    },
    {
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合科研写作、文献综述、论文初稿打磨和研究项目管理。",
          "适用线索：Agents and non-interactive runs should use npx hyperframes skills update instead — it installs exactly the core set, whereas skills add --all installs all 21 published skills."
        ]
      }
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/2383268?s=40&v=4",
      ...
      "insight": {
        "source": "readme",
        "readmeTitle": "No AI Slop",
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：Removes 20+ patterns of AI slop from any piece of writing.",
        "projectIntro": "该项目的 GitHub 简介是：Removes 20+ patterns of AI slop from any piece of writing.",
        "featurePoints": [
          "核心线索：Removes 20+ patterns of AI slop from any piece of writing."
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。",
          "适用线索：The easiest way to install the skill is to paste this into ChatGPT, Claude Code, Codex, or your favorite coding agent:"
        ]
      }
    }
  ],
  "monthly": [
    ...
    },
    {
      ...
      "insight": {
        ...
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：Editorial diagram design for Claude Code, Codex, and Pi. Self-contained HTML + SVG. No shadows. No Mermaid slop.",
        "projectIntro": "该项目的 GitHub 简介是：Editorial diagram design for Claude Code, Codex, and Pi. Self-contained HTML + SVG. No shadows. No Mermaid slop.",
        "featurePoints": [
          "核心线索：Editorial diagram design for Claude Code, Codex, and Pi. Self-contained HTML + SVG. No shadows. No Mermaid slop."
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。"
        ]
