window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-06-23T04:16:32.2710597+00:00",
  "weekly": [
    {
      "owner": "Panniantong",
      "repo": "Agent-Reach",
    ...
    },
    {
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。",
          "适用线索：See the self-hosting guide for deployment options (Vercel, Docker, static)."
        ]
      }
    },
    {
