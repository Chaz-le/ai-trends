window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-08-30T06:36:03.1836045+00:00",
  "weekly": [
    {
      "owner": "tt-a1i",
      "repo": "archify",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/20476625?s=40&v=4",
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合习惯命令行开发、希望用 AI 处理代码修改、调试和多步骤工程任务的开发者。",
          "适用线索：Re-run the same command to update. When prompted, choose at least one coding agent and optionally RTK. You can review the installers before running them: install.sh and install.ps1."
        ]
      }
    },
    {
    ...
    },
    {
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合科研写作、文献综述、论文初稿打磨和研究项目管理。",
          "可按 README 示例落地：The agent proposes the workflow; you review it on a canvas and save it."
        ]
      }
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/18739364?s=40&v=4",
      ...
      "insight": {
        "source": "readme",
        "readmeTitle": "Awesome Agent Skills",
        "category": "terminal-coding-agent",
        "zhTitle": "终端 AI 编码 Agent",
        "zhIntro": "在命令行里运行的 AI 编码 Agent，集成代码编辑、LSP、浏览器、Python、子 Agent 和更可靠的改动定位能力。",
        "projectIntro": "在命令行里运行的 AI 编码 Agent，集成代码编辑、LSP、浏览器、Python、子 Agent 和更可靠的改动定位能力。",
  ...
  "monthly": [
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/44305048?s=40&v=4",
      ...
      "insight": {
        "source": "readme",
        "readmeTitle": "Clone and install dependencies",
        "category": "other",
        "zhTitle": "AI 开源工具",
        "zhIntro": "该项目的 GitHub 简介是：🎯 All you need. Nothing you don't. Open source project management that works for you, not against you.",
        "projectIntro": "该项目的 GitHub 简介是：🎯 All you need. Nothing you don't. Open source project management that works for you, not against you.",
        "featurePoints": [
          "核心线索：🎯 All you need. Nothing you don't. Open source project management that works for you, not against you."
        ],
        "scenarioPoints": [
          "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。",
          "适用线索：For straightforward deployments, use drim - a CLI tool that handles everything for you:"
        ]
      }
    }
  ]
