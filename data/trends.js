window.GITHUB_AI_TRENDS = {
    "source":  "GitHub Trending + GitHub Repo API + structured Chinese insights",
    "generatedAt":  "2026-06-16T15:07:36.4480767+08:00",
    "weekly":  [
                   {
                       "owner":  "addyosmani",
                       "repo":  "agent-skills",
                   ...
                   },
                   {
                       ...
                       "insight":  {
                                       ...
                                       "category":  "other",
                                       "zhTitle":  "AI 开源工具",
                                       "zhIntro":  "该项目的 GitHub 简介是：An interface library for RL post training with environments.",
                                       "projectIntro":  "该项目的 GitHub 简介是：An interface library for RL post training with environments.",
                                       "featurePoints":  [
                                                             "核心线索：An interface library for RL post training with environments."
                                                         ],
                                       "scenarioPoints":  [
                                                              "适合先打开仓库 README 和示例快速试用，再判断是否值得接入自己的工作流。"
                                                          ]
