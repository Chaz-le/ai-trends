window.GITHUB_AI_TRENDS = {
  ...
  "generatedAt": "2026-07-29T03:30:06.8257219+00:00",
  "weekly": [
    {
      "owner": "mattpocock",
      "repo": "skills",
    ...
    },
    {
      ...
      "avatarUrl": "https://avatars.githubusercontent.com/u/12794925?s=40&v=4",
      ...
      "insight": {
        ...
        "scenarioPoints": [
          "适合经常用 Claude Code、Codex、Cursor 做真实项目开发的人，把常用工程规范变成 Agent 可执行技能。",
          "适用线索：Pi Web has no application-level authentication and can invoke a high-privilege agent. Do not expose it to the internet; only use non-loopback bindings on a trusted network."
        ]
      }
    }
  ],
